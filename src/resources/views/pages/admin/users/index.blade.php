...
@section('title','Debriefings-system | Users')
@section('content')
                ...
                <div class="relative z-10">
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="flex gap-1 opacity-0 group-hover:opacity-100 transition-all translate-x-4 group-hover:translate-x-0 duration-300">
                            ...
                            <button type="button" onclick="triggerDelete('{{ $user->id }}', '{{ $user->first_name }} {{ $user->last_name }}')" 
                    ...
                    <h3 class="text-lg font-black text-slate-800 mb-1 group-hover:text-indigo-600 transition-colors">{{ $user->first_name }} {{ $user->last_name }}</h3>
                ...
                <form id="userForm" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="first_name" id="first_name" required class="w-full px-5 py-4 bg-slate-50 border-2 border-transparent focus:border-indigo-500 rounded-2xl font-bold text-slate-700 outline-none transition-all">
                        </div>
                        <div class="space-y-2">
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Last Name</label>
                            <input type="text" name="last_name" id="last_name" required class="w-full px-5 py-4 bg-slate-50 border-2 border-transparent focus:border-indigo-500 rounded-2xl font-bold text-slate-700 outline-none transition-all">
                        </div>
                    </div>
