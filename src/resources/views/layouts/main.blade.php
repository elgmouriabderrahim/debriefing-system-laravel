...
<body class="bg-[#f8fafc] text-slate-900 antialiased font-sans tracking-tight">
    ...
    <div class="flex min-h-screen relative">
        ...
        <main id="mainContent" class="ml-60 flex-1 transition-all duration-500 min-h-screen flex flex-col">
            ...
            <header class="h-16 bg-white/80 backdrop-blur-xl sticky top-0 z-40 px-8 flex items-center justify-between border-b border-slate-200/50">
                ...
                <div class="flex items-center gap-6">
                    <div class="text-right hidden sm:block">
                        <p class="text-sm font-black text-slate-900 leading-none">{{ $user->firstName ?? 'Super' }} {{ $user->lastName ?? 'Admin' }}</p>
                    ...
                    <div class="h-12 w-12 bg-slate-900 rounded-2xl border-4 border-white shadow-xl overflow-hidden group cursor-pointer active:scale-95 transition-all">
                        <img src="https://ui-avatars.com/api/?name={{ $user->firstName }}&background=0f172a&color=fff" alt="User">
                    </div>
                </div>
            </header>
